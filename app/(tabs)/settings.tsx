...
import { SegmentedTabs, type SegmentOption } from '@/src/components/SegmentedTabs';
...
import {
  ...
  normalizeHexColor,
} from '../../src/features/settings/utils';

type SettingsSection = 'general' | 'design' | 'account' | 'system';
...
export default function SettingsScreen() {
  ...
  const sectionOptions = useMemo<SegmentOption<SettingsSection>[]>(() => {
    const labels =
        language === 'en'
            ? {
              general: 'General',
                    ...
                    {savedMeClub ? (
                        <View style={[styles.savedBox, { borderColor: colors.border }]}>
                          ...
                          <View style={styles.savedBoxText}>
                            ...
                            <Text style={[styles.savedBoxMeta, { color: colors.mutedText }]} numberOfLines={1}>
                              {getClubDisplayName(savedMeClub) || t('settings.clubSavedTitle')} ·{' '}
                              {formatClubId(savedMeClub)}
                            </Text>
                          </View>
                  ...
                  <View style={styles.colorPickerBox}>
                    ...
                    >
                      ...
                      <View style={styles.colorWheelRow}>
                        <HueCircular thumbSize={28} sliderThickness={22} style={styles.hueCircular} />
                  ...
                  <View style={styles.swatchGrid}>
                    {accentSwatches.map((swatch) => {
                      ...
                      return (
                          ...
                          >
                            {selected ? <Ionicons name="checkmark" size={17} color={swatchIconColor} /> : null}
                          </Pressable>
                      );
                    })}
                  </View>
                        ...
                        {myttStatus ? (
                            <View
                                style={[
                                  ...
                                  {
                                    borderColor:
                                        myttStatus.hasSession && !myttStatus.expired ? '#16a34a' : colors.border,
                  ...
                  {health ? (
                      <Text
                          style={[
                            ...
                            {
                              color:
                                  health.includes('erreichbar') || health.includes('reachable')
                                      ? '#16a34a'
                                      : colors.destructive,
                            },
                          ]}
